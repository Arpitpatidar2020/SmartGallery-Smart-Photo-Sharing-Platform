...
import { loginUser, googleLogin as googleLoginApi } from '../../services/authService'
...
const LoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const redirect = location.state?.redirectTo || (data.user.role === 'admin' ? '/admin' : '/user')
  ...
  return (
    <div className="min-h-screen bg-dark-950 flex items-center justify-center p-4 relative">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-1/3 right-1/4 w-72 h-72 bg-accent-cyan/8 rounded-full blur-3xl" />
      </div>
        ...
        <div className="glass-card p-6 sm:p-8">
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="px-3 bg-dark-900 text-dark-500 uppercase tracking-wider font-medium">or sign in with email</span>
            </div>
          </div>
